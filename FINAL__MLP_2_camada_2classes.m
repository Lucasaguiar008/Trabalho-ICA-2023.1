...
%caminnho_salvar = "C:\Users\Notebook\Desktop\TRABALHO AMORA 3\RNA\30_05\Programa Final 2\Resultados 2 classes\2 camadas\Tangente Hiperbólica\";
for experimento=1:length(matriz)
    for rodada=1:10
        ...
        % Definir o novo nome do arquivo
        novoNome = ["Rodada_"+num2str(rodada)+"_Camada_n1_"+num2str(num_oculta1)+"_Camada_n2_"+num2str(num_oculta2)+"_Acurácia_valicacao_"+ num2str(acuracia_percentual_validacao,2)+".fig"];

        % Salvar a figura com o novo nome do arquivo
        savefig(novoNome);

                %Criando a tabela de resultados
        rodada_res = ["Rodada: "+num2str(rodada)+"_N = "+num2str(num_oculta1)+"_N = "+num2str(num_oculta2)];
